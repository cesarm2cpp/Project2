...
int calculateBreakfast() {// company BREAKFAST_COVERED = 9
    ...
    if(departer < 7 && arrival > 8) {// on day 1 depature < 7am and arrival on last day > 8am. both
        breakfastNumber = days;
    } else if (departer < 7 && arrival < 8) {// departure < 7am and arrival < 8am. no arrival breakfast
        breakfastNumber = days - 1;
    } else if (departer > 7 && arrival > 8) {// departure > 7am and arrival > 8am. no departure breakfast
        breakfastNumber = days - 1;
    } else if (departer > 7 && arrival < 8) {// 1st day and last day no breakfast. departure > 7am && arrival < 8am
...
int calculateLunch() {// company LUNCH_COVERED = 12
    ...
    int lunchNumber = 0;
    if(departer < 12 && arrival > 1) {// on day 1 departure < 12pm and arrival on last day > 1pm. both allowed
        lunchNumber = days;
    } else if(departer < 12 && arrival < 1) {// departure < 12pm and arrival < 1pm. no arrival lunch
        lunchNumber = days - 1;
    } else if(departer > 12 && arrival > 1) {// departure > 12pm and arrival > 1pm. no departure lunch
        lunchNumber = days - 1;
    } else if(departer > 12 && arrival < 1) {// 1st day and last day no lunch. departure > 12pm && arrival < 1pm
        lunchNumber = days - 2;
    }
...
int calculateDinner() {// company DINNER_COVERED = 16
    int dinnerNumber = 0;
    if(departer < 6 && arrival > 7) {// on day 1 departure < 6pm and arrival on last day > 7pm. both allowed
        dinnerNumber = days;
    } else if(departer < 6 && arrival < 7) {// departure < 6pm and arrival < 7pm. no arrival dinner
        dinnerNumber = days - 1;
    } else if(departer > 6 && arrival > 7) {// depature > 6pm and arrival > 7pm. no departure dinner
        dinnerNumber = days - 1;
    } else if(departer > 6 && arrival < 7) {// 1st day and last day no dinner. departure > 6pm && arrival < 7pm
        dinnerNumber = days - 2;
    }
